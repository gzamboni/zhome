...
# This resource will wait until the AdGuard Home instance is ready before proceeding
...
resource "adguard_list_filter" "adguard_list_filter_entry" {
  depends_on = [adguard_config.adguard_zhome]
